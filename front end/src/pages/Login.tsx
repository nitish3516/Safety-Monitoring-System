    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground">PPE Guard AI</h1>
          <p className="text-muted-foreground mt-1">Smart Safety Monitoring System</p>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border p-8">
          ...
          <div className="space-y-3">
            <button className="w-full py-3 bg-muted/50 rounded-xl font-medium text-foreground hover:bg-muted transition-colors flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="w-full py-3 bg-muted/50 rounded-xl font-medium text-foreground hover:bg-muted transition-colors"
            >
              Demo Login (Admin)
            </button>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-5">
            Don't have an account? <button className="text-primary hover:underline">Register</button>
          </p>
        </div>
      </div>
    </div>
